...
void champions_info() {
    ...
    champions.push_back(make_tuple("제드", "Cyper", "", "Slayer", "", 4, "Fronter")); 
    champions.push_back(make_tuple("미스포춘", "Syndicate", "", "Dynamo", "", 4, "Backer")); 
    champions.push_back(make_tuple("벡스", "DivineCorp", "", "Executioner", "", 4, "Backer")); 
    champions.push_back(make_tuple("레오나", "AminaSquad", "", "Vanguard", "", 4, "Fronter")); 
    champions.push_back(make_tuple("아펠리오스", "GoldenOx", "", "Marksman", "", 4, "Backer"));
    champions.push_back(make_tuple("자야", "AminaSquad", "", "Marksman", "", 4, "Backer")); 
    champions.push_back(make_tuple("니코", "StreetDemon", "", "Strategist", "", 4, "Fronter")); 
    champions.push_back(make_tuple("직스", "Cyberboss", "", "Strategist", "", 4, "Backer")); 
    champions.push_back(make_tuple("제리", "Exotech", "", "Rapidfire", "", 4, "Backer")); 
    champions.push_back(make_tuple("세주아니", "Exotech", "", "Bastion", "", 4, "Fronter")); 
    champions.push_back(make_tuple("애니", "GoldenOx", "", "AMP", "", 4, "Backer")); 
    champions.push_back(make_tuple("브랜드", "StreetDemon", "", "Techie", "", 4, "Backer")); 
    champions.push_back(make_tuple("초가스", "Boombot", "", "Bruiser", "", 4, "Fronter")); 

    champions.push_back(make_tuple("가렌", "GodofNW", "", "", "", 5, "Fronter")); 
    champions.push_back(make_tuple("코부코", "Cyberboss", "", "Bruiser", "", 5, "Fronter")); 
    champions.push_back(make_tuple("오로라", "AminaSquad", "", "Dynamo", "", 5, "Backer")); 
    champions.push_back(make_tuple("레넥톤", "Overload", "DivineCorp", "Bastion", "", 5, "Fronter")); 
    champions.push_back(make_tuple("자크", "Virus", "", "", "", 5, "Fronter")); 
    champions.push_back(make_tuple("우르곳", "Boombot", "", "Executioner", "", 5, "Backer")); 
    champions.push_back(make_tuple("비에고", "GoldenOx", "SoulKiller", "Techie", "", 5, "Fronter")); 
    champions.push_back(make_tuple("사미라", "StreetDemon", "", "AMP", "", 5, "Backer")); 
}
...
int synerge_check(int index) {
    ...
    // origin
    if (AminaSquad[index] >= 3 && AminaSquad[index] < 5) synerge_count += 8;
    ...
    if (Cyberboss[index] >= 2 && Cyberboss[index] < 3) synerge_count += 5;
    else if (Cyberboss[index] >= 3 && Cyberboss[index] < 4) synerge_count += 10;  
    else if (Cyberboss[index] >= 4) synerge_count += 18;

    if (Exotech[index] >= 3 && Exotech[index] < 5) synerge_count += 8;
    ...
    if (DivineCorp[index] >= 1 && DivineCorp[index] < 2) synerge_count += 3;
    ...
    if (AMP[index] >= 2 && AMP[index] < 3) synerge_count += 5;
    ...
    if (Dynamo[index] >= 2 && Dynamo[index] < 3) synerge_count += 5;
...
string synerge_print(int index) {
    ...
    if (Cyper[index] >= 3 && Cyper[index] < 4) synerge.append("3사이퍼 ");
    else if (Cyper[index] >= 4 && Cyper[index] < 5) synerge.append("4사이퍼 ");
    else if (Cyper[index] >= 5) synerge.append("5사이퍼 ");  
