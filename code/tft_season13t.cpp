...
void champions_info() {
    ...
    champions.push_back(make_tuple("이렐리아", "Enforcer", "", "Sentinel", "", 1, "Fronter")); 
    champions.push_back(make_tuple("럭스", "Acamedy", "", "Sorcerer", "", 1, "Backer"));
    ...
    champions.push_back(make_tuple("레오나", "Acamedy", "", "Sentinel", "", 2, "Fronter")); 
    ...
    champions.push_back(make_tuple("이즈리얼", "Acamedy", "Rebel", "Artillerist", "", 3, "Backer")); 
    ...
    champions.push_back(make_tuple("누누와윌럼프", "Experiment", "", "Bruiser", "Visionary", 3, "Fronter")); 
    ...
    champions.push_back(make_tuple("문도박사", "Experiment", "", "Dominator", "", 4, "Fronter")); 
    ...
    champions.push_back(make_tuple("하이머딩거", "Acamedy", "", "Visionary", "", 4, "Backer")); 
    ...
    champions.push_back(make_tuple("제이스", "Acamedy", "", "Form_Swapper", "", 5, "ANY")); 
...
int synerge_check(int index) {
    ...
    if (Black_Rose[index] >= 3 && Black_Rose[index] < 4) synerge_count += 100; 
    ...
    if (Experiment[index] >= 3 && Experiment[index] < 5) synerge_count += 100; 
    else if (Experiment[index] >= 5 && Experiment[index] < 7) synerge_count += 15; 
    else if (Experiment[index] >= 7) synerge_count += 30;
    
    if (Enforcer[index] >= 2 && Enforcer[index] < 4) synerge_count += 100;
    ...
    if (Conqueror[index] >= 2 && Conqueror[index] < 4) synerge_count += 100; 
    ...
    if (Chem_Baron[index] >= 3 && Chem_Baron[index] < 4) synerge_count += 100;
    ...
    if (Family[index] >= 2 && Family[index] < 3) synerge_count += 100;
    else if (Family[index] >= 3 && Family[index] < 4) synerge_count += 10; 
    else if (Family[index] >= 4) synerge_count += 19;

    if (Scrap[index] >= 2 && Scrap[index] < 4) synerge_count += 100; 
    ...
    if (Academy[index] >= 3 && Academy[index] < 4) synerge_count += 100; 
    ...
    if (Emissary[index] >= 1 && Emissary[index] < 2) synerge_count += 100; 
    ...
    if (Sentinel[index] >= 2 && Sentinel[index] < 4) synerge_count += 100;
    else if (Sentinel[index] >= 4 && Sentinel[index] < 6) synerge_count += 12;
    else if (Sentinel[index] >= 6) synerge_count += 25;

    if (Visionary[index] >= 2 && Visionary[index] < 4) synerge_count += 100;
    ...
    if (Pit_Fighter[index] >= 2 && Pit_Fighter[index] < 4) synerge_count += 100;
    ...
    if (Sorcerer[index] >= 2 && Sorcerer[index] < 4) synerge_count += 100;
...
void synerge_add(tuple <string, string, string, string, string, int, string> &champion, int index) {
    ...
    else if (classes1 == "Academy") Academy[index]++;
...
string synerge_print(int index) {
    ...
    if (Family[index] >= 3 && Family[index] < 4) synerge.append("3가족 ");  
    else if (Family[index] >= 4 && Family[index] < 5) synerge.append("4가족 ");
    else if (Family[index] >= 5) synerge.append("5가족 "); 
